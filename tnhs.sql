...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2015 at 03:10 AM
...
--
-- Table structure for table `tbl_sa`
--

CREATE TABLE IF NOT EXISTS `tbl_sa` (
  `id` int(11) NOT NULL,
  `quest_id` int(11) NOT NULL,
  `answer` text NOT NULL,
...
--
-- Dumping data for table `tbl_sa`
--

INSERT INTO `tbl_sa` (`id`, `quest_id`, `answer`, `partyid`) VALUES
(1, 2, 'Application Development Framework', 16),
(2, 3, 'It is fast', 16),
(3, 4, 'Segment based approach', 16),
(4, 5, 'him', 16);
...
ALTER TABLE `tbl_question`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `tbl_sa`
--
ALTER TABLE `tbl_sa`
